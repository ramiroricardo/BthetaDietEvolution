...
#load data
d84_para_gene<-read_xlsx("analysis/genomics/evolved_populations_breseq/D84_prokkaREF_MQ20_BQ30_v3ref/downstreamAnalysis/breseq_output_day84_longFormat_parallelMutations_withAnnotations_freqPerGene_c.xlsx")
...
The figures below corresponds to Fig. 5A and S5E
```{r,fig.width=10}
...
d84_para_gene_halla<-read_tsv("analysis/multiomics/halla/d84_paralleMutations_freqPerGene_halla.tsv")
physeq_d84_melt_filt_halla<-read_tsv("analysis/multiomics/halla/d84_microbiome_halla.tsv")
metab_d84_halla<-read_tsv("analysis/multiomics/halla/d84_metabolome_halla.tsv")
...
dynamics_long_annot<-read_xlsx("analysis/genomics/evolved_populations_breseq/temporalDynamics_prokkaREF_MQ20_BQ30_v3ref/downstreamAnalysis/breseq_output_temporalDynamics_longFormat_woutLowConfMutations_withAnnotations_c.xlsx")
